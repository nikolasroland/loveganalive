    ...
    angular.module('starter.utils', []).run(['$rootScope', '$state', '$ionicHistory', function($rootScope, $state, $ionicHistory) {
        window.addEventListener('message', function(e) {
            if (e.data.func == 'getAuthCallback') {
                ...
                var ydElement = document.getElementById('ydContent');
                var $ydScope = angular.element(ydElement).scope();
                if ($ydScope)
                    $ydScope.afterGetAuth();
                var amElement = document.getElementById('amContent');
                var $amScope = angular.element(amElement).scope();
                if ($amScope)
                    $amScope.afterGetAuth();
                ...
                var appElement = document.getElementById('payContent');
                var $scope = angular.element(appElement).scope();
                if ($scope)
                    $scope.doRefresh(e.data.resp.isSuccess);
            }
        });
    }]);
})();
