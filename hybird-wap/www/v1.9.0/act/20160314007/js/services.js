...
.factory('Serv', function($http, $q, $ionicPopup, $ionicLoading) {
    return {
        ...
        buyProduct: function(productCode, insurancePeople, insuranceMobile, insuranceAddress, detail, insuranceDistribution, insuranceRecipe, insurancePrescription) {
            var deferred = $q.defer();
            $ionicLoading.show();
            var auth = window.localStorage.getItem('auth'),
                userId = window.localStorage.getItem('userId'),
            ...
            formData.append('insurancePeople', insurancePeople);
            formData.append('insuranceMobile', insuranceMobile);
            formData.append('insuranceAddress', insuranceAddress);
            formData.append('insuranceDistribution', insuranceDistribution);
            formData.append('insuranceRecipe', insuranceRecipe);
            formData.append('insurancePrescription', insurancePrescription);
