...
.config(function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('doctor-list', {
            url: "/doctor-list/:doctorId/:doctorName",
            templateUrl: "views/doctor-list.html?013",
            controller: 'DoctorListCtrl'
        })
        .state('doctor-plan', {
            url: "/doctor-plan/:doctorId/:doctorName/:orderId/:orderCode",
            templateUrl: "views/doctor-plan.html?013",
            controller: 'DoctorPlanCtrl'
        })
