...
.run(function($rootScope) {
    ...
    $rootScope.phone = 1;
    if (isMobile.Android()) $rootScope.phone = 1;
    else if (isMobile.iOS()) $rootScope.phone = 2;
    else if (isMobile.Windows()) $rootScope.phone = 3;
    else if (isMobile.BlackBerry()) $rootScope.phone = 4;
    else $rootScope.phone = 5;
})
